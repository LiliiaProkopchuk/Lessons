                        ...
                        if (json.results.length != 0) {
                            ...
                            <div class="film_item">
                                ...
                                <div class="film_info">
                                   ...
                                   <button data-id="${item.id}" data-title="${item.title}" data-image="${image}" onclick="toggleFav($(this))" class="heart${fav_class}"></button>
                    ...
                    success: function (json) {
                        ...
                        if (json.Search != undefined) {
                            for (let i = 0; i < json.Search.length; i++) {
                                ...
                                <div class="film_item">
                                <div class="film_poster">
                                <img src="${image}" alt="${item.Title}" style="width:200px; height:300px">
                                </div>
                                    <div class="film_info">
                                       <h3>${item.Title}</h3>
                                       ...
                                       <button href="javascript:void(0)" data-id="${item.imdbID}" data-title="${item.Title}" data-image="${image}" onclick="toggleFav($(this))" class="heart${fav_class}"></button>
                                       <div class="film_detail"></div>
                                    </div>
                                </div>
                                `;
            ...
            if (!$lnk.hasClass("disabled")) {
                ...
                $.ajax({
                    ...
                    success: function (json) {
                        ...
                        $lnk.parents(".alert_body").find(".film_detail").html(rez);
                        $lnk.parents(".alert_body").find(".film_detail").show();
